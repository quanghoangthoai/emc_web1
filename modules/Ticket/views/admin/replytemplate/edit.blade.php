...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <h4><i class="fa fa-ticket-alt mr-2"></i> <span class="font-weight-semibold">Yêu cầu hỗ trợ</span> - Mẫu phản hồi #{{ $ReplyTemplate_edit['id'] }}</h4>
...
<div class="card-body">
    <div class="row">
        <div class="col-xl-7">
            @include('Ticket::admin.replytemplate.component_edit')
        </div>
        <div class="col-xl-5">
