...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <h4><i class="fa fa-file-alt mr-2"></i> <span class="font-weight-semibold">Slide</span> - Sửa</h4>
...
<form action="{{ route('mod_slide.admin.post_edit_slide', $slide['id']) }}" method="post">
    {{ csrf_field() }}
        ...
        <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input id="txtTitle" name="title" value="{{ old('title', $slide['title']) }}" type="text" class="form-control" placeholder="Nhập tiêu đề">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group areaBrowserFile">
                            <input placeholder="Chưa chọn hình ảnh" readonly type="text" id="page-image" class="form-control" name="image" value="{{ old('image', $slide['image']) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea name="description" rows="4" class="form-control" placeholder="Mô tả thiệu ngắn">{{ old('description', $slide['description']) }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"><strong>Nội dung nút liên kết</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-9">
                        <input id="" name="button_text" value="{{ old('button_text', $slide['button_text']) }}" type="text" class="form-control" placeholder="Nhập text button">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"><strong>Đường dẫn liên kết</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-9">
                        <input id="" name="link" value="{{ old('link',$slide['link']) }}" type="text" class="form-control" placeholder="Nhập đường dẫn url">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4 p-0">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select name="block_id" class="form-control">
                        ...
                        {{-- <option value="{{ $block['id'] }}" {{ old('block_id',$slide['bloctétk_id'])  == $block['id'] ? 'selected' : '' }}> {{ $block['name'] }} --}}
                        <option value="{{ $block['id'] }}" {{ old('block_id',$slide['block_id']) == $block['id'] ? 'selected' : '' }}>{{ $block['name'] }}
                        </option>
                        @endforeach
                        @endif
                    </select>
                    ...
                    <div class="col-lg-9">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="status" type="radio" class="form-check-input-styled" {{ old('status', $slide['status']) == 1 ? 'checked' : '' }} value="1">
                                    </div>
                                </div>
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="status" type="radio" class="form-check-input-styled" {{ old('status', $slide['status']) == 0 ? 'checked' : '' }} value="0">
                                    </div>
                                </div>
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <button type="submit" class="btn btn-info btn-sm">Sửa slide</button></div>
            </div>
        </div>
    </div>
</form>
