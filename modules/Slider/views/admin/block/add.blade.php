...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <h4><i class="fa fa-file-alt mr-2"></i> <span class="font-weight-semibold">Khu vực hiển thị</span> - Thêm</h4>
        <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
    </div>
    <div class="header-elements d-none">
        <div class="d-flex justify-content-center">
            <a href="{{route('mod_block.admin.list_block')}}" class="btn btn-primary btn-sm">Danh sách khu vực</a>
        </div>
    </div>
</div>
@endsection
@section('page_content')
<form action="{{ route('mod_block.admin.add_block') }}" method="post">
    {{ csrf_field() }}
    <div class="row ml-0 mr-0">
        <div class="card-body">
            <div class="form-group row">
                <label class="col-form-label col-lg-3"><strong>Tên khối</strong> <sup class="text-danger">(*)</sup></label>
                <div class="col-lg-9">
                    <input name="name" value="{{ old('name') }}" type="text" class="form-control" placeholder="Nhập tên khối">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <button type="submit" class="btn btn-info btn-sm">Thêm khối</button>
                    </div>
                </div>
            </div>
        </div>
