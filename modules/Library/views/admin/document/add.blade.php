...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <h4><i class="icon-tree7 mr-2"></i> <span class="font-weight-semibold">Thư viện</span> - Thêm tài liệu</h4>
...
<form action="{{ route('mod_library.admin.post_add_document') }}" method="post">
    {{ csrf_field() }}
        ...
        <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="txtTitle" placeholder="Nhập tên tài liệu" class="form-control" name="name" value="{{ old('name') }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group areaBrowserFile">
                            <input placeholder="Chưa chọn tệp" readonly type="text" id="doc-file" class="form-control" name="attach_file" value="{{ old('attach_file') }}">
                            <div class="input-group-prepend mr-0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea placeholder="Nhập mô tả ngắn gọn" name="short_description" class="form-control" rows="5">{{ old('short_description') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group areaBrowserFile">
                            <input placeholder="Chưa chọn hình ảnh" readonly type="text" id="doc-image" class="form-control" name="image" value="{{ old('image') }}">
                            <div class="input-group-prepend mr-0">
                                <button class="btn btn-light btn-sm btn-remove-file text-danger" type="button"><i class="fa fa-times"></i></button>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        <select class="form-control" name="category_id">
                            ...
                            <option value="{{ $iCategory['id'] }}" {{ old('category_id') == $iCategory['id'] ? 'selected' : '' }}>{{$iCategory['prefix']}} {{ $iCategory['name'] }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
