...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <h4><i class="fa fa-file-alt mr-2"></i> <span class="font-weight-semibold">Tin tuyển dụng</span> - Đăng tin</h4>
...
<form action="{{ route('mod_recruitment.admin.post_add_job') }}" method="post">
    {{ csrf_field() }}
        ...
        <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input name="position" value="{{ old('position') }}" type="text" class="form-control" placeholder="Nhập vị trí tuyển dụng">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"><strong>Số người cần tuyển</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-9">
                        <input name="people_number" value="{{ old('people_number', 1) }}" type="number" min="1" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"><strong>Hình thức làm việc</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-9">
                        <input name="work_type" value="{{ old('work_type') }}" type="text" class="form-control" placeholder="Toàn thời gian, bán thời gian, thời vụ,...">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"><strong>Mức lương</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-9">
                        <input name="salary" value="{{ old('salary') }}" type="text" class="form-control" placeholder="Nhập mức lương">
                    </div>
                </div>
                <hr>
                <div class="form-group row">
        ...
        <div class="col-md-4 p-0">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-12">
                        <input name="expired_at" value="{{ old('expired_at') }}" type="text" class="form-control datepicker" placeholder="Chọn ngày">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-12"><strong>Địa chỉ tuyển dụng</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-12">
                        <input name="work_address" value="{{ old('work_address') }}" type="text" class="form-control" placeholder="Nhập địa chỉ tuyển dụng">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-12"><strong>Thông tin liên hệ</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-12">
                        <textarea name="contact_info" rows="3" class="form-control" placeholder="Nhập thông tin liên hệ">{{ old('contact_info') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-12"><strong>Website</strong></label>
                    <div class="col-lg-12">
                        <input name="link" value="{{ old('link') }}" type="text" class="form-control" placeholder="Nhập website">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="text-right">
                    ...
                    <button type="submit" class="btn btn-info btn-sm">Đăng tin</button>
                </div>
            </div>
        </div>
    </div>
