...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <h4><i class="fa fa-file-alt mr-2"></i> <span class="font-weight-semibold">Trang</span> - Thêm</h4>
...
<form action="{{ route('mod_page.admin.post_add_page') }}" method="post">
    {{ csrf_field() }}
        ...
        <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea name="description" rows="4" class="form-control" placeholder="Nhập giới thiệu ngắn">{{ old('description') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
        ...
        <div class="col-md-4 p-0">
            <div class="card-body">
                ...
                <div class="text-right">
                    ...
                    <button type="submit" class="btn btn-info btn-sm">Thêm trang</button>
                </div>
            </div>
        </div>
    </div>
