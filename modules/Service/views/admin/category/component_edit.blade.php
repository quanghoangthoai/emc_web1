<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('mod_service.admin.post_edit_category', $category_edit['id']) }}" method="post">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <input name="name" id="txtTitle" type="text" class="form-control" placeholder="Nhập tên danh mục" value="{{ old('name', $category_edit['name']) }}">
            </div>
            <div class="form-group">
            ...
            <div class="float-right">
                <a href="{{ route('mod_service.admin.list_category') }}" class="btn btn-dark btn-sm">Hủy bỏ</a>
