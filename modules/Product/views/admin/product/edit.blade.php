...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <h4><i class="fa fa-cube mr-2"></i> <span class="font-weight-semibold">Sản phẩm</span> - #{{ $product['id'] }}</h4>
...
<form action="{{ route('mod_product.admin.post_edit_product', $product['id']) }}" method="post">
    {{ csrf_field() }}
        ...
        <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input placeholder="Nhập tên sản phẩm" type="text" name="name" class="form-control" value="{{ old('name', $product['name']) }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            <input type="number" class="form-control" name="price" value="{{ old('price', $product['price']) }}" min="0" step="1000">
                            <span class="input-group-append ml-0"><span class="input-group-text">đ / </span></span>
                            <span class="input-group-append ml-0"><input placeholder="đơn vị tính" type="text" class="form-control" name="unit_type" value="{{ old('unit_type', $product['unit_type']) }}"></span>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="display_price" type="radio" class="form-check-input-styled" {{ old('display_price', $product['display_price']) == 1 ? 'checked' : '' }} value="1">
                                    </div>
                                </div>
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="display_price" type="radio" class="form-check-input-styled" {{ old('display_price', $product['display_price']) == 0 ? 'checked' : '' }} value="0">
                                    </div>
                                </div>
                ...
                <div id="collapsible-saleoff" class="collapse show">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input name="enable_sale" type="checkbox" class="form-check-input-styled" value="1" {{ old('enable_sale', $product['enable_sale']) ? 'checked' : '' }}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input autocomplete="off" name="sale_time" type="text" class="form-control daterange-basic" value="{{ old('sale_time', $product['sale_time']) }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input type="number" class="form-control" name="sale_price" value="{{ old('sale_price', $product['sale_price']) }}" min="0" step="1000">
                                <span class="input-group-append ml-0"><span class="input-group-text">đ</span></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group areaBrowserFile">
                            <input placeholder="Chưa chọn hình ảnh" readonly type="text" id="product-image" class="form-control" name="image" value="{{ old('image', $product['image']) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea placeholder="Nhập mô tả ngắn" name="description" rows="4" class="form-control">{{ old('description', $product['description']) }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-12 col-form-label"><strong>Nội dung chi tiết</strong></label>
                    <div class="col-lg-12">
                        <textarea id="content" name="content" rows="3" class="form-control">{{ old('content', $product['content']) }}</textarea>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-12">
                        <select name="category_id" class="form-control">
                            ...
                            <option value="{{ $cat['id'] }}" {{ old('category_id', $product['category_id']) == $cat['id'] ? 'selected' : '' }}>{{ $cat['prefix'] }} {{ $cat['name'] }}
                            </option>
                            @endforeach
                            @endif
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input name="featured" type="checkbox" class="form-check-input-styled" value="1" {{ old('featured', $product['featured']) ? 'checked' : '' }}>
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="status" type="radio" class="form-check-input-styled" {{ old('status', $product['status']) == 1 ? 'checked' : '' }} value="1">
                                    </div>
                                </div>
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="status" type="radio" class="form-check-input-styled" {{ old('status', $product['status']) == 0 ? 'checked' : '' }} value="0">
                                    </div>
                                </div>
