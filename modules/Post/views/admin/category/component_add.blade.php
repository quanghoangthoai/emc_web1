<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('mod_post.admin.post_add_category') }}" method="post">
            {{ csrf_field() }}
            <div class="form-group">
                ...
                <select name="parent_id" class="form-control">
                    ...
                    <option value="{{ $cat['id'] }}" {{ old('parent_id') == $cat['id'] ? 'selected' : '' }}>{{ $cat['prefix'] }} {{ $cat['title'] }}
                    </option>
                    @endforeach
                    @endif
                </select>
            ...
            <div class="form-group">
                ...
                <input name="title" id="txtTitle" type="text" class="form-control" placeholder="Nhập tên danh mục" value="{{ old('title') }}">
            </div>
            <div class="form-group">
